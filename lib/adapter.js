...
class JasmineAdapter {
    ...
    async run () {
        ...
        jasmine.getEnv().executionFilters = this.config.executionFilters
        ...
        await executeHooksWithArgs(this.config.before, [this.capabilities, this.specs, this.config.executionFilters])
